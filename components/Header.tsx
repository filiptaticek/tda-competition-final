  ...
  return (
    <div>
      <div className="m-auto mb-10 hidden w-[92%] md:flex">
        ...
        <div
          className={clsx(
            "w-[60%] text-center text-5xl font-bold",
            mode ? "text-white " : ""
          )}>
          <p className="m-auto flex w-fit">
            ...
            <span
              className={
                !mode ? "text-light_blue hover:opacity-80" : "text-white"
              }>
              &nbsp;notes.
            </span>
          </p>
      ...
      <>
        <div className="m-auto flex w-full md:hidden">
          ...
          <div className="flex w-[50%] justify-end">
            <img
              className="mr-2 h-[40px] cursor-pointer"
              src={i18n.language == "en" ? "cs.png" : "en.png"}
              onClick={() =>
        ...
        <p
          className={clsx(
            "mb-8 mt-4 w-full text-center text-4xl font-bold md:hidden",
            mode ? "text-white" : ""
          )}>
          CHANGE
          <span
            className={clsx(!mode ? "text-light_blue" : "text-white", "block")}>
            THE TEXT.
          </span>
        </p>
      </>
