...
export const UniversalForm = ({
  ...
  return (
    <div
      ...
      <form
        className={
          "relative m-auto w-[300px] rounded-xl border border-black bg-white p-10 text-black sm:w-[500px]"
        }
        onSubmit={onSubmit}>
        <motion.img
          whileHover={{ scale: 1.3 }}
          className="relative bottom-[15px] left-[220px] cursor-pointer sm:left-[415px]"
